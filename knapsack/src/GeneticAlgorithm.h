...
private:
    ...
    int knapsack_weight;
    int object_max_value;
    int number_of_objects;
    std::vector<int> objects_values;
    std::vector<int> objects_weights;
...
//    long double computeValueOfChromosome(const Chromosome & chromosome) const;
...
public:
    ...
    void print_objects() {
        std::cout << "Weights:\n";
        for (const auto &x :this->objects_weights) {
            std::cout << x << " ";
        }
        std::cout << "\nValues:\n";
        for (const auto &x :this->objects_values) {
            std::cout << x << " ";
        }
        std::cout<<'\n';
    }
